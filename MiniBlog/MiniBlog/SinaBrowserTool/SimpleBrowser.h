...
public:
   ...
   // controls
	...
	void Navigate2(            /* [in] */ __RPC__in VARIANT *URL,
	...
	IHTMLDocument3 *GetDocument3();			// get document interface; returns NULL 
...
class WeiboServiceBase1 :public SimpleBrowser
{
protected:
	...
	BOOL GetCookie(IHTMLDocument2 *pDoc2,CString& refString);
public:
