...
protected:
	...
	BOOL GetCookie(CString& refString);
	BOOL GetHtml(CString& refString);
	BOOL GetScript(CString& refString);
...
public:
	...
	HRESULT  Navigate2(VARIANT *URL,VARIANT *Flags,VARIANT *TargetFrame,VARIANT *PostData,VARIANT *Headers);
	//HRESULT  Navigate2( COleVariant URL,  COleVariant  Flags,COleVariant TargetFrameName,COleVariant PostData,COleVariant Headers);
